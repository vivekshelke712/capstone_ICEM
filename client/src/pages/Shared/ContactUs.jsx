...
const ContactUs = () => {
    return <>
        <Navbar />
   <section class="bg-blue-50 text-black" id="contact">
            ...
            <div class="grid md:grid-cols-2">
                <div class="h-full pr-6">
                    <p class="mt-3 mb-12 text-lg text-black">
                     Need help with campus recruitment? Connect with us for personalized support and partnership opportunities. Our team is here to assist you every step of the way
                    </p>
                    <ul class="mb-6 md:mb-0">
                        <li class="flex">
                            ...
                            <div class="ml-4 mb-4">
                                ...
                                <p class="text-black">Training and placement office ,Deogiri College</p>
                                <p class="text-black">Chhatrapati SambhajiNagar</p>
                            </div>
                        </li>
                        <li class="flex">
                            <div class="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                            ...
                            <div class="ml-4 mb-4">
                                ...
                                <p class=" text-black">Mobile: +1 (123) 456-7890</p>
                                <p class=" text-black">Mail: connect@deogiricampus.com</p>
                            </div>
                        </li>
                        <li class="flex">
                            <div class="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                            ...
                            <div class="ml-4 mb-4">
                                <h3 class="mb-2 text-lg font-medium leading-6 text-black">Working
                                    hours</h3>
                                <p class="text-black">Monday - Friday: 08:00 - 17:00</p>
                                <p class="text-black">Saturday &amp; Sunday: 08:00 - 12:00</p>
                            </div>
                        </li>
                    </ul>
                </div>
