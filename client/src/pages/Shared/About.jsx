...
const About = () => {
  ...
  <div className="md:w-1/2">
    ...
    <h3 className="text-5xl font-bold my-4">How AidBridge Raised 1M</h3>
    <p className="text-gray-400">
      At AidBridge, we’ve built strong connections with donors, volunteers, and communities to bridge the gap between resources and those in need. Together, we’ve turned compassion into action, making a lasting impact on countless lives.
    </p>
    <div className="flex space-x-8 mt-6">
      <div>
        <p className="text-2xl font-semibold">1M+</p>
        <p className="text-gray-400">Donations Raised</p>
      </div>
      <div>
  ...
  <div className="max-w-6xl mx-auto px-6">
    ...
    <div className="text-center mb-12">
      ...
      <p className="text-gray-600 mt-2">
        At AidBridge, we are a passionate team of changemakers, dedicated to building bridges between resources and communities in need.
      </p>
    </div>
        ...
        <div key={index} className="text-center">
          ...
          <div className="flex justify-center space-x-4 mt-4 text-gray-600">
            {member.socials?.facebook && (
              <a href={member.socials.facebook} aria-label="Facebook" className="hover:text-blue-600">
            ...
            {member.socials?.twitter && (
              <a href={member.socials.twitter} aria-label="Twitter" className="hover:text-blue-400">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
            ...
            {member.socials?.linkedin && (
              <a href={member.socials.linkedin} aria-label="LinkedIn" className="hover:text-blue-700">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
